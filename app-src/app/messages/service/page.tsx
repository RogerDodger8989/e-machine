...
import { getAudienceFilterOptions } from "@/lib/audienceBuilder";
...
export default async function ServiceRemindersPage() {
  const [reminders, filterOptions, smsTemplate, emailTemplate] = await Promise.all([
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">
        ...
        Filtrera på tillverkare/kategori/modell/inköpsår för att smalna av listan. Välj
        vilka som ska få ett utskick och på vilken kanal — inget skickas förrän du klickar
        Skicka.
      </p>
